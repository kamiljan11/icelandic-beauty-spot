...
const translations = {
  ...
  features: [
    {
      icon: Globe,
      label: { en: "Natural Ingredients", is: "Náttúruleg efni", pl: "Naturalne składniki" },
    },
    {
      icon: Camera,
      label: { en: "Luxury Experience", is: "Lúxus upplifun", pl: "Luksusowe doznania" },
    },
    {
      icon: BarChart3,
      label: { en: "Proven Results", is: "Sannað árangur", pl: "Udowodnione efekty" },
    },
    {
      icon: Zap,
      label: { en: "Instant Glow", is: "Tafarlaus birta", pl: "Natychmiastowy blask" },
    },
  ],
  cta: { en: "BOOK NOW", is: "BÓKA TÍMA", pl: "UMÓW SIĘ" },
  price: {
    en: "From only 5.900 kr./treatment",
    is: "Frá aðeins 5.900 kr./meðferð",
    pl: "Już od 5.900 kr./zabieg",
  },
  perks: {
...
const CtaBanner = () => {
  ...
  return (
    <section className="bg-volcanic py-20 md:py-28">
      <div className="max-w-4xl mx-auto px-6 text-center">
        <p className="font-body text-sm tracking-[0.3em] uppercase text-gold mb-6">
          {t(translations.subtitle)}
        </p>
        <h2 className="font-display text-4xl md:text-6xl font-light text-cream leading-tight mb-2">
          {t(translations.title1)}
        </h2>
        <h2 className="font-display text-4xl md:text-6xl font-light italic text-gold leading-tight mb-8">
          {t(translations.title2)}
        </h2>
        <p className="font-body text-base text-cream/60 leading-relaxed max-w-2xl mx-auto mb-12">
